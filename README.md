# FUTURE-_DS_02
Customer Retention &amp; Churn Analysis Dashboard built using Excel and Power BI to analyze churn trends, retention drivers, and customer behavior through interactive data visualization.
